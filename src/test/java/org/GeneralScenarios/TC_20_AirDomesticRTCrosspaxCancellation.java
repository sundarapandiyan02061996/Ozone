...
public class TC_20_AirDomesticRTCrosspaxCancellation extends BaseClass {
	...
	public void Ticketing() throws Throwable
	{
		...
		B.FilterRequestRT(getdata2xlsheet(0, 27, 2));
		B.logout();
	}
	...
	public void AirCencellationbyCA() throws Throwable
	{
		...
		M.CancelRTCrosspaxFlightbooking(27);
		D.Logout();
	}
	...
	@Test(priority=4)
		public void CancellationConfirmbyCU() throws Throwable
		{
			...
			l.AgencyUser();	
			BookingQueuePage B = new BookingQueuePage();
			B.CrosspaxFlightcancelRT(getdata2xlsheet(0, 27, 2));
			B.logout();
		}
}
