...
public class TC_06_InternationalOnewaybyCU extends BaseClass {
	...
	@Test(priority=1)
	public void AirOWInternationalbooking() throws Throwable
	{
		implicitwait();
	...
	public void ApprovetheRequest() throws Throwable
	{
		...
		C.ViewTransactionhistory(getdata2xlsheet(0, 7, 3));
		PriceSummaryPage P = new PriceSummaryPage();
		P.Approve();
