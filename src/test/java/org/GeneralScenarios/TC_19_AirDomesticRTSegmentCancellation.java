...
public class TC_19_AirDomesticRTSegmentCancellation extends BaseClass {
	...
	public void Ticketing() throws Throwable
	{
		...
		B.FilterRequestRT(getdata2xlsheet(0, 26, 2));
		B.logout();
	}
	...
	public void AirCencellationbyCA() throws Throwable
	{
		...
		M.CancelRTsegmentFlightbooking(26);
		D.Logout();
	}
	...
	@Test(priority=4)
		public void CancellationConfirmbyCU() throws Throwable
		{
			...
			l.AgencyUser();	
			BookingQueuePage B = new BookingQueuePage();
			B.Flightcancel(getdata2xlsheet(0, 26, 2));
			B.logout();
		}
